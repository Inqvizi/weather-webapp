...
const TRANSLATIONS: Record<AppLanguage, TranslationDictionary> = {
  en: {
    ...
    map: {
      ...
      subtitle: 'Real-time rain radar and precipitation coverage powered by RainViewer',
      layerRadar: 'Standard Radar',
      layerNexrad: 'NEXRAD High-Contrast',
      play: 'Play',
      pause: 'Pause',
      ...
      radarUnavailable: 'Radar frames unavailable. Check connection.',
      viewCityWeather: 'View full forecast',
      legendHelp: 'Universal precipitation radar palette',
    },
  },
  uk: {
    nav: {
    ...
    map: {
      title: 'Інтерактивна мапа та радар опадів',
      subtitle: 'Живий радар опадів у реальному часі на базі RainViewer',
      layerRadar: 'Стандартний радар',
      layerNexrad: 'NEXRAD (Контраст)',
      play: 'Старт',
      pause: 'Пауза',
      prevFrame: 'Попередній кадр',
      nextFrame: 'Наступний кадр',
      live: 'Зараз',
      forecast: 'Прогноз',
      past: 'Минуле',
      opacity: 'Прозорість',
      recenter: 'Центрувати на місті',
      legendTitle: 'Інтенсивність опадів',
      light: 'Слабкий',
      moderate: 'Помірний',
      heavy: 'Сильний',
      extreme: 'Злива / Град',
      snow: 'Сніг',
      loadingRadar: 'Завантаження даних радара...',
      radarUnavailable: 'Дані радара недоступні. Перевірте зʼєднання.',
      viewCityWeather: 'Переглянути прогноз',
      legendHelp: 'Універсальна шкала інтенсивності опадів',
    },
  },
};
