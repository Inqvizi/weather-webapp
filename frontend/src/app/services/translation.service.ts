...
const TRANSLATIONS: Record<AppLanguage, TranslationDictionary> = {
  en: {
    ...
    map: {
      ...
      subtitle: 'Real-time rain radar and satellite cloud coverage powered by RainViewer',
      layerRadar: 'Precipitation',
  ...
  uk: {
    ...
    map: {
      ...
      subtitle: 'Живий радар опадів та супутникова хмарність на базі RainViewer',
      layerRadar: 'Опади',
      layerSatellite: 'Хмарність',
      play: 'Старт',
      pause: 'Пауза',
